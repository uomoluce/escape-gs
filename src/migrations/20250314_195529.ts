...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE IF NOT EXISTS "curatorship" (
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "sound_design" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"year" numeric NOT NULL,
  	"title" varchar NOT NULL,
  	"platform" varchar NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "payload_locked_documents_rels" (
  	...
  	"mixes_id" integer,
  	"events_id" integer,
  	"curatorship_id" integer,
  	"sound_design_id" integer,
  ...
  DO $$ BEGIN
   ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_discography_fk" FOREIGN KEY ("discography_id") REFERENCES "public"."discography"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_mixes_fk" FOREIGN KEY ("mixes_id") REFERENCES "public"."mixes"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_curatorship_fk" FOREIGN KEY ("curatorship_id") REFERENCES "public"."curatorship"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_sound_design_fk" FOREIGN KEY ("sound_design_id") REFERENCES "public"."sound_design"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "discography_updated_at_idx" ON "discography" USING btree ("updated_at");
  CREATE INDEX IF NOT EXISTS "discography_created_at_idx" ON "discography" USING btree ("created_at");
  CREATE INDEX IF NOT EXISTS "mixes_media_idx" ON "mixes" USING btree ("media_id");
  CREATE INDEX IF NOT EXISTS "mixes_updated_at_idx" ON "mixes" USING btree ("updated_at");
  CREATE INDEX IF NOT EXISTS "mixes_created_at_idx" ON "mixes" USING btree ("created_at");
  ...
  CREATE INDEX IF NOT EXISTS "curatorship_updated_at_idx" ON "curatorship" USING btree ("updated_at");
  CREATE INDEX IF NOT EXISTS "curatorship_created_at_idx" ON "curatorship" USING btree ("created_at");
  CREATE INDEX IF NOT EXISTS "sound_design_media_idx" ON "sound_design" USING btree ("media_id");
  CREATE INDEX IF NOT EXISTS "sound_design_updated_at_idx" ON "sound_design" USING btree ("updated_at");
  CREATE INDEX IF NOT EXISTS "sound_design_created_at_idx" ON "sound_design" USING btree ("created_at");
  ...
  CREATE INDEX IF NOT EXISTS "payload_locked_documents_rels_discography_id_idx" ON "payload_locked_documents_rels" USING btree ("discography_id");
  CREATE INDEX IF NOT EXISTS "payload_locked_documents_rels_mixes_id_idx" ON "payload_locked_documents_rels" USING btree ("mixes_id");
  ...
  CREATE INDEX IF NOT EXISTS "payload_locked_documents_rels_curatorship_id_idx" ON "payload_locked_documents_rels" USING btree ("curatorship_id");
  CREATE INDEX IF NOT EXISTS "payload_locked_documents_rels_sound_design_id_idx" ON "payload_locked_documents_rels" USING btree ("sound_design_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "discography" CASCADE;
  DROP TABLE "mixes" CASCADE;
  DROP TABLE "events" CASCADE;
  DROP TABLE "curatorship" CASCADE;
  DROP TABLE "sound_design" CASCADE;
